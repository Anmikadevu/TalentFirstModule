    ...
    public class ProfileService : IProfileService
    {
        ...
        public async Task<bool> UpdateTalentProfile(TalentProfileViewModel model, string updaterId)
        {
            ...
            if(model.Id!=null)
            {
                ...
                var newRlanguage = new List<UserLanguage>();
                foreach (var item in model.Languages)
                {
                   ...
                   newRlanguage.Add(language);
                }
                existingUser.Languages =newRlanguage;
                var newRskill= new List<UserSkill>();
                ...
                existingUser.Skills = newRskill;
                var newRexperience = new List<UserExperience>();
                foreach (var item in model.Experience)
                {
                   ...
                   newRexperience.Add(experience);
                }
                existingUser.Experience= newRexperience;
